...
export const name = 'survsendloremsg';
...
export const execute: Execute = async (bot: Bot, message: Message) => {
  ...
  Ahora, las tierras cercanas al palacio se empiezan a corromper poco a poco con magia oscura y seres malignos.
  A Qyona y a los Semi Dioses se les agotan las fuerzas, y como último contraataque para mantener lo que queda de tierra libre de todo mal y por toda la eternidad, decidieron unir fuerzas y levantar la tierra del mismísimo suelo.
  
  Todos ellos entregaron su alma y sus últimos esfuerzos en fusionarse con la tierra y la naturaleza, levantando poco a poco las pesadas rocas, creando bajo la isla un lago que poco a poco separará todo mal cercano de su hogar.
  
  La leyenda dice que el espíritu de Qyona sigue vivo, vigilando y protegiendo la zona, aunque nadie puede confirmar el haberla visto,  y que si llegas a ser tan fuerte como lo fueron los primeros aventureros y liberas sus tierras del mal, también recompensará a los elegidos."
  
  - Os ha gustado? Obvio que si  -*se ríe*-
  - La próxima vez contaré vuestra historia...`);
